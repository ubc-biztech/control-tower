/**
 * The fabricated world, kept for demos and for working without credentials.
 * Selected with VITE_TOWER_DATA_SOURCE=mock. The live path is liveApi.ts;
 * api.ts picks between them.
 *
